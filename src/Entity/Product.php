...
//     private ?stringint $price;
    ...
    /**
     * One product has many trims. This is the inverse side.
     * @var Collection<int, ProductTrims>
     */
    // #[OneToMany(targetEntity: ProductTrims::class, mappedBy: 'product')]
    // private Collection $productTrims;

    #[JoinTable(name: 'product_trims')]
    #[JoinColumn(name: 'product_id', referencedColumnName: 'id')]
    #[InverseJoinColumn(name: 'id', referencedColumnName: 'id', unique: true)]
    #[ManyToMany(targetEntity: 'ProductTrims')]
    private Collection $productTrims;
    ...
    public function __construct()
    {
     ...
     /**
     * @return Collection<int, ProductTrims>
     */
    public function getProductTrims(): Collection
    {
        return $this->productTrims;
    }

    public function getVinResposne()
    {
        return $this->vin_response;
    }

    public function setVinResposne( $vin_response): self
    {
        $this->vin_response = $vin_response;
